...
class MainView(tk.Frame):
    ...
    def mostrar_inicio(self):
        ...
        tk.Label(
            self.contenido,
            text="Seleccione una opción superior para visualizar la información cargada.",
            bg=self.color_fondo,
            fg=self.color_texto,
            font=("Arial", 12),
        ).pack(anchor="w")
    ...
    def mostrar_productos(self):
        ...
        for producto in self.restaurante_servicio.listar_productos():
            texto = f"{producto.codigo} - {producto.nombre} | Precio: ${producto.precio}"
    ...
    def mostrar_funcionalidad_pendiente(self):
        messagebox.showinfo(
            "Próximamente",
            "Funcionalidad que será incorporada posteriormente.",
        )
